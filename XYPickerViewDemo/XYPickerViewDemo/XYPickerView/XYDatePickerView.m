...
@interface XYDatePickerView () {
    ...
    XYDateResultBlock _resultBlock;
...
+ (void)showDatePickerWithTitle:(NSString *)title
                ...
                defaultSelValue:(NSString *)defaultSelValue
                   ...
                   isAutoSelect:(BOOL)isAutoSelect
                    resultBlock:(XYDateResultBlock)resultBlock {
    
    XYDatePickerView *datePickerView = [[XYDatePickerView alloc]initWithTitle:title dateType:type defaultSelValue:defaultSelValue minDateStr:(NSString *)minDateStr maxDateStr:(NSString *)maxDateStr isAutoSelect:isAutoSelect resultBlock:resultBlock];
